      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-5 px-4 pb-6 pt-2">
        ...
        <section className="card p-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="block rounded-lg border border-line px-3 py-2.5 text-center text-sm font-medium hover:border-accent"
          >
            링크허브 열기 ↗
          </a>
        </section>
        ...
        <section className="card p-4">
          <h2 className="mb-1 text-sm font-semibold">
            저장함 <span className="font-normal text-ink-soft">({activeWatches}/{limits.itemsMax})</span>
          </h2>
